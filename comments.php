...
<?php if ( have_comments() ) : ?>
	...
	<h4 id="comments"><?php comments_number('No Comments so Far', 'One Comment', '% Comments' );?></h4>
...
<div id="respond">
	...
	<form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
		...
		<div id="comment-user-details"><?php do_action('alt_comment_login'); ?>
				...
				<div>
					<label for="email">E-Mail (will not be published) <?php if ($req) echo "(required)"; ?></label><br />
