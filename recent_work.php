...
<section class="main-col">
	<div class="site-container">
		...
		<ul class="technologies">
			<li class="css">CSS</li>
			<li class="rails">Ruby on Rails 3.2</li>
			<li class="rails">PostgreSQL</li>
			<li class="css">Amazon S3 Storage</li>
			<li class="css">Bootstrap for Rails</li>
	...
	<div class="site-container">
		...
		<div class="subfeatures">
			...
			<img src="<?php bloginfo('template_directory'); ?>/images/my-work/finis_sub2.jpg">
			<img class="last" src="<?php bloginfo('template_directory'); ?>/images/my-work/finis_sub3.jpg">
		</div>
		<ul class="technologies">
			<li class="css">CSS</li>
			<li class="jQuery">PHP</li>
			<li class="rails">Magento</li>
			<li class="haml">Fireworks</li>
			<li class="haml">HTML</li>
			<li class="jQuery">jQuery</li>
		</ul>
	</div>
	<div class="site-container">
		...
		<div class="subfeatures">
			...
			<img src="<?php bloginfo('template_directory'); ?>/images/my-work/upmygame_sub2.jpg">
			<img class="last" src="<?php bloginfo('template_directory'); ?>/images/my-work/upmygame_sub3.jpg">
		</div>
		<ul class="technologies">
			<li class="css">CSS</li>
			<li class="haml">Fireworks</li>
	...
	<div class="site-container">
		<h3>Custom Swimsuit Studio by FINIS</h3>
		<h4>Objective</h4>
		...
		<ul class="technologies">
			<li class="css">CSS</li>
			<li class="rails">Ruby on Rails 2.3</li>
			<li class="rails">PostgreSQL</li>
			<li class="rails">Heroku</li>
			<li class="jQuery">jQuery</li>
		</ul>
	</div>
	<div class="site-container">
		<h3>Streamline Training Log</h3>
		<h4>Objective</h4>
	...
	<div class="site-container">
		...
		<ul class="technologies">
			...
			<li class="rails">Ruby on Rails 3.2</li>
			<li class="rails">PostgreSQL</li>
			<li class="css">Bootstrap Responsive</li>
			<li class="jQuery">jQuery</li>
			<li class="jQuery">Google Images API</li>
		</ul>
	</div>
	<div class="site-container">
		<h3>OptiFridge</h3>
		...
		<ul class="technologies">
			...
			<li class="rails">Ruby on Rails 3.2</li>
			<li class="rails">PostgreSQL</li>
			<li class="rails">OCR (Optical Character Recognition)</li>
			<li class="css">Amazon S3 Storage</li>
			<li class="css">Bootstrap for Rails</li>
			<li class="haml">Fireworks</li>
			<li class="jQuery">jQuery</li>
